...
import com.api.apibackend.common.*;
import com.api.apibackend.constant.UserConstant;
import com.api.apibackend.model.dto.user.*;
...
import com.api.apicommon.model.emums.UserAccountStatusEnum;
...
import com.api.apibackend.annotation.AuthCheck;
...
import static com.api.apibackend.constant.EmailConstant.*;
import static com.api.apibackend.constant.UserConstant.ADMIN_ROLE;
import static com.api.apibackend.utils.EmailUtil.buildEmailContent;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        // ak/sk
        String accessKey = DigestUtils.md5DigestAsHex((user.getUserAccount() + UserConstant.SALT + UserConstant.VOUCHER).getBytes());
        String secretKey = DigestUtils.md5DigestAsHex((UserConstant.SALT + UserConstant.VOUCHER + user.getUserAccount()).getBytes());
    ...
    public BaseResponse<Page<UserVO>> listUserByPage(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        ...
        String balance = userQueryRequest.getBalance();
        ...
        queryWrapper.like(StringUtils.isNotBlank(userName), "userName", userName)
                ...
                .eq(StringUtils.isNotBlank(balance), "balance", balance)
