...
import com.api.apibackend.model.enums.ProductTypeStatusEnum;
...
public class OrderServiceImpl implements OrderService {
    ...
    private void checkBuyRechargeActivity(Long userId, Long productId) {
        ...
        if (productInfo.getProductType().equals(ProductTypeStatusEnum.RECHARGE_ACTIVITY.getValue())) {
            ...
            orderLambdaQueryWrapper.and(qw ->
                    qw.eq(ProductOrder::getStatus, PaymentStatusEnum.NOTPAY.getValue())
                            .or()
                            .eq(ProductOrder::getStatus, PaymentStatusEnum.SUCCESS.getValue())
            );
