...
INSERT INTO qi_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime,
...
INSERT INTO qi_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime,
                                 createTime, updateTime, isDelete)
VALUES (1697087470134259713, '10坤币', '签到获取', 1692848556158709762, 0, 10, 'RECHARGE', 0, null, '2023-08-31 11:22:37',
        '2023-08-31 11:22:37', 1);

INSERT INTO qi_api.interface_info
VALUES ('1705234447153963010',
        '随机毒鸡汤',
...
INSERT INTO qi_api.interface_info
VALUES ('1705237104270712833',
        '获取输入的名称',
        'https://gateway.qimuu.icu/api/name',
        '1698354419367571457',
        'GET',
        '[{\"id\":\"1695031845159\",\"fieldName\":\"name\",\"type\":\"string\",\"desc\":\"输入的名称\",\"required\":\"是\"}]',
        '1',
        'https://gateway.qimuu.icu/api/name?name=zhangshan',
        null,
        null,
        '获取输入的名称',
        '2',
        '0',
        'https://img.qimuu.icu/interface_avatar/1699981437456797697/XqT3Nsto-psc.jfif',
        'JSON',
...
VALUES ('1705237990061580289',
        ...
        '1',
        'https://gateway.qimuu.icu/api/randomWallpaper?lx=dongman',
        null,
        null,
        '获取随机壁纸',
        '1',
        '1',
        'https://img.qimuu.icu/typory/logo.jpg',
        'JSON',
...
VALUES ('1705238841173942274', '每日星座运势', 'https://gateway.qimuu.icu/api/horoscope', '1698354419367571457', 'GET',
        ...
        '1', 'https://gateway.qimuu.icu/api/horoscope?type=scorpio&time=nextday', null, null, '获取每日星座运势', '1', '3',
...
INSERT INTO qi_api.interface_info
VALUES ('1705239469589733378', '随机土味情话', 'https://gateway.qimuu.icu/api/loveTalk', '1698354419367571457', 'GET', null,
        '1', 'https://gateway.qimuu.icu/api/loveTalk', null, null, '获取土味情话', '1', '0',
...
VALUES ('1705240565347459073',
        ...
        '1',
        'https://gateway.qimuu.icu/api/weather?ip=180.149.130.16',
        null,
        null,
        '获取每日每周的天气信息',
        '1',
        '1',
        'https://img.qimuu.icu/interface_avatar/1698354419367571457/gYNay1Y0-weather.png',
        'JSON',
